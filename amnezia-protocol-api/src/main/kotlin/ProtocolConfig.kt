...
open class ProtocolConfig protected constructor(
    ...
    open class Builder(blockingMode: Boolean) {
        ...
        fun hasDnsServers(): Boolean = dnsServers.isNotEmpty()
        ...
        private fun processRoutes() {
            ...
            // Android rejects loopback route entries in VpnService.Builder. Local
            // pluggable transports can make OpenVPN report 127.0.0.1 as the
            // remote endpoint, so filter both include and exclude loopback routes.
